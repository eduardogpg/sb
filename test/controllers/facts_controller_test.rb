...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post facts_url, params: { fact: { code: @fact.code, color: @fact.color, description: @fact.description, real: @fact.real, resource: @fact.resource, title: @fact.title } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { code: @fact.code, color: @fact.color, description: @fact.description, real: @fact.real, resource: @fact.resource, title: @fact.title } }
